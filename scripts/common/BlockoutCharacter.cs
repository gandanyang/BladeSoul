...
namespace Oniblade.Common;

public partial class BlockoutCharacter : Node3D
{
	public Node3D HeadPivot { get; private set; }
	public Node3D ArmLeft { get; private set; }
	public Node3D ArmRight { get; private set; }
	public Node3D LegLeft { get; private set; }
	public Node3D LegRight { get; private set; }
	public Node3D WeaponPivot { get; private set; }
